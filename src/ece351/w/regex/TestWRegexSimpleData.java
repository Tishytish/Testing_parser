...
// TODO: short code snippet
regexs.add("[A-Za-z]*: (0|1)*(\\s)*(0|1)*(\\s)*;\\s*");

		// r6.wave
		// Copy the regex from above and paste it here.
		// Generalize the regex to allow multiple spaces between values.
// TODO: short code snippet
regexs.add("[A-Za-z]*(\\s)*: (0|1)*(\\s)*(0|1)*(\\s)*;\\s*");
...
// TODO: short code snippet
regexs.add("([A-Za-z]*(\\s)*: (\\s)*(0|1)(\\s*(0|1))*(\\s)*;\\s*)*");
